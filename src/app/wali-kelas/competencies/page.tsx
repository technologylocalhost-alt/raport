...
export default function WaliKelasCompetenciesPage() {
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className={editingId || showModal ? 'lg:col-span-2' : 'lg:col-span-3'}>
          ...
          <div className="bg-white rounded-lg shadow p-4 mb-6">
            <div className="flex items-center justify-between gap-4">
              ...
              <button 
                ...
                className="bg-emerald-600 text-white px-4 py-2 rounded-lg hover:bg-emerald-700 transition-colors flex items-center gap-2 whitespace-nowrap text-sm"
              >
                <Plus size={18} />
                Tambah
              </button>
                ...
                <table className="w-full">
                  ...
                  <tbody className="divide-y divide-gray-200">
                    {filteredCompetencies.map((comp, index) => (
                      <tr key={comp.id} className={`hover:bg-gray-50 transition-colors ${editingId === comp.id ? 'bg-emerald-50' : ''}`}>
          ...
          {/* Summary */}
          {!isLoading && filteredCompetencies.length > 0 && (
            <div className="bg-emerald-50 border border-emerald-200 text-emerald-800 px-4 py-3 rounded-lg flex items-center justify-between mt-6">
            ...
            <div className="bg-white rounded-lg shadow sticky top-6">
              ...
              <div className="bg-gradient-to-r from-emerald-600 to-emerald-700 px-6 py-4 flex items-center justify-between">
                ...
                <button
                  ...
                  className="text-white hover:bg-emerald-800 p-1 rounded-lg transition-colors"
                >
                  <X size={24} />
                </button>
              </div>
              ...
              <form onSubmit={handleSubmit} className="p-6 space-y-4">
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-emerald-500 text-sm bg-white text-gray-900"
                  />
                </div>
                ...
                <div className="flex gap-3 pt-4 border-t border-gray-200">
                  ...
                  <button
                    type="submit"
                    disabled={isSubmitting}
                    className="flex-1 bg-emerald-600 text-white px-4 py-2 rounded-lg hover:bg-emerald-700 transition-colors font-medium text-sm disabled:bg-gray-400"
                  >
